...
IMPORTANT: If these two checks are not successful you will not able to run ansible tasks. Review all the configuration in ansible controller node and ansible linux clients until these two checks are successfully passed.
