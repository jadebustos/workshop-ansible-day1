...
NOTE: If no public/private key is create it can be created using **ssh-keygen** command.
...
IMPORTANT: Use your favorite editor to create the **/etc/sudoers.d/ansible** file.
